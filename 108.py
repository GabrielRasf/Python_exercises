...
busca = input('O que você busca? ')

for produto in produtos:
    if busca in produto["nome"].lower():
        print('Busca pelo nome: {}'.format(produto))
for produto in produtos:
    if busca in produto["categoria"].lower(): 
        print('busca pela categoria: {}'.format(produto))
for produto in produtos:
    if busca in str(produto["preco"]):
        print('Busca pelo preco: {}'.format(produto))